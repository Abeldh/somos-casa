...
export const orderController = {
  ...
  async updateStatus(req, res, next) { try { return successResponse(res, await orderService.updateStatus(req.params.id, req.body.status), 'Estado actualizado'); } catch (e) { next(e); } },
};
