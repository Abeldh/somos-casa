        ...
        <div className="p-3 sm:p-4 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-50">
            ...
            {isAuthenticated && book.stock > 0 && (
              <button onClick={handleAdd} className="w-8 h-8 bg-primary-50 hover:bg-primary-100 text-primary-600 rounded-lg flex items-center justify-center transition-colors" title="Agregar al carrito">
